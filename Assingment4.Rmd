...
abundance_line <- as.data.frame(size_clean) %>% 
  ...
  xlab("Year") +
  ylab("Total Count")+
  ggtitle("Lobster Abundance at Long-Term Ecological Research Sites in the Santa Barbara Channel")+
  theme_classic()
...
pressure_line <- as.data.frame(pressure_clean) %>% 
  ...
  xlab("Year") +
  ylab("Total Pressure")+
  ggtitle("Lobster Pressure at Long-Term Ecological Research Sites in Santa Barbara Channel")+
  theme_classic()

pressure_line

>>>>>>> 5f9e53d487d7916bbd5600b13ee8bca301c4a1ed
```
