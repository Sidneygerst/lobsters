...
summarylength <- mean_comp %>% 
  kable(col.names=c("Site", "Mean Length (mm)", "Standard Deviation", "Variance", "Maximum Length (mm)", "Minimum Length (mm)"), caption = "Table 3. The mean, maximum and minimum lengths of lobster carapices for LTER sites in the Santa Barbara Channel in 2017 - TH, EM, SG") %>% 
...
MPA_sites_2012 <- MPA_sites %>% 
  filter(STATUS == "MPA") %>% 
  filter(YEAR == "2012")

MPA_sites_2017 <- MPA_sites %>% 
  filter(STATUS == "MPA") %>% 
  filter(YEAR == "2017")
